import { AnalyticsRepository, MonthlyData, DailyData, StaffPerformanceData, CourseSalesData, OptionSalesData, MarketingChannelData } from '../types/analytics';
import { generateMonthlyData, generateDailyData, staffPerformanceData, generateCourseSalesData, generateOptionSalesData, generateMarketingChannelData } from './data';
