...
describe('getPublicCastDetail', () => {
  ...
  it('returns only public profile fields even if a database mock supplies private relations', async () => {
    mocks.castFindFirst.mockResolvedValue({
      ...
      panelTakeHomeBonusTier: { name: 'パネルUP A', price: 1000 },
      regularTakeHomeBonusTier: { name: '本指名UP B', price: 2000 },
    ...
    expect(detail).toEqual(
      expect.objectContaining({
        ...
        name: 'Alice',
        specialDesignationFee: 3000,
        panelTakeHomeBonusLabel: 'パネルUP A',
        panelTakeHomeBonus: 1000,
        regularTakeHomeBonusLabel: '本指名UP B',
