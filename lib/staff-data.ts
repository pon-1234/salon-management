...
export const staffMembers: StaffMember[] = [
  ...
  },
  {
    ...
    image: 'https://rimane.net/images/tyrano-move-image01.jpg',
    description:
      '落ち着いた雰囲気で、丁寧な接客が好評です。マッサージの腕前も確かで、特にリラックスを求めるお客様に人気があります。',
    netReservation: true,
  ...
  },
  {
    ...
    image: 'https://rimane.net/images/tyrano-move-image01.jpg',
    description:
      '小柄でキュートな外見と、意外な大人の魅力を併せ持つスタッフです。細やかな気配りが得意で、初めてのお客様にも安心して利用いただけます。',
    netReservation: true,
...
export function generateSchedule(staff: StaffMember): ScheduleDay[] {
  ...
  return Array.from({ length: 11 }, (_, i) => {
    ...
    if (i === 2) {
      ...
      const bookings = staff.appointments.filter(
