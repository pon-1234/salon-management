...
export const reviewsData: Review[] = [
  {
    ...
    customerArea: '豊島区',
    rating: 5,
    content: '容姿もとても綺麗でスタイルも抜群でした！密着も素晴らしかったですし、マッサージもすごくよかったです！',
  ...
  },
  {
    ...
    customerArea: '豊島区',
    rating: 5,
    content: '初心者でも入り込みやすい、接客能力。マッサージ技術も独特なものがあり身体が楽になりました。',
  ...
  },
  {
    ...
    customerArea: '文京区',
    rating: 5,
    content: '今日は本当にありがとうございました！見た目も可愛くて、スタイルも良くて最高でした。マッサージも気持ち良くて、時間があっという間に過ぎました。',
  ...
  },
  {
    ...
    customerArea: '板橋区',
    rating: 4,
    content: '優しく丁寧な接客で安心してお任せできました。睾丸マッサージは初めてでしたが、とても気持ち良かったです。',
  ...
  },
  {
    ...
    customerArea: '新宿区',
    rating: 5,
    content: 'プロフィール通りの美人さんでした！トークも楽しく、技術も素晴らしくて大満足です。絶対リピートします！',
    ...
    response: {
      content: 'この度はご利用いただきありがとうございました。楽しんでいただけて本当に嬉しいです♪次回もお待ちしております！',
  ...
  },
  {
    ...
    customerArea: '中野区',
    rating: 5,
    content: '前立腺マッサージをお願いしました。初めてでしたが優しく丁寧にしてくれて、新しい世界が開けました。',
  ...
  },
  {
    ...
    customerArea: '練馬区',
    rating: 4,
    content: 'とても可愛い女の子でした。マッサージも上手で疲れが取れました。ただ時間が少し短く感じたので次は長めのコースにします。',
  ...
  },
  {
    ...
    customerArea: '世田谷区',
    rating: 5,
    content: 'Gカップの爆乳に圧倒されました！密着度も最高で、まさに天国でした。回春増し増しオプション最高です！',
  ...
  },
  {
    ...
    customerArea: '豊島区',
    rating: 5,
    content: '新人さんとのことでしたが、とても頑張ってくれました。一生懸命な姿に癒されました。応援したくなる女の子です。',
    ...
    tags: ['新人', '一生懸命', '癒し系'],
    response: {
      content: '温かいお言葉ありがとうございます！まだまだ未熟ですが、これからも頑張ります。またお会いできるのを楽しみにしています♪',
  ...
  },
  {
    ...
    customerArea: '杉並区',
    rating: 5,
    content: 'ランキング1位なだけあって最高でした！Gカップの破壊力とテクニックの両方を兼ね備えた女神です。',
  ...
  },
  {
    ...
    customerArea: '新宿区',
    rating: 4,
    content: '初めての利用でしたが、優しくリードしてくれました。密着洗髪スパが気持ち良すぎて寝そうになりました。',
  ...
  },
  {
    ...
    tags: ['リピーター', '期待以上', '安定感'],
    response: {
      content: 'いつもありがとうございます♪リピートしていただけて本当に嬉しいです！次回も全力で頑張りますね♡',
