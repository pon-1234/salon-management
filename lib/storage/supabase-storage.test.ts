...
describe('SupabaseStorageService', () => {
  ...
  describe('upload', () => {
    ...
    it('should upload file successfully', async () => {
      ...
      const mockPublicUrl =
        'https://test.supabase.co/storage/v1/object/public/test-bucket/uploads/123-abc.jpg'
    ...
    it('should throw error if file type is not allowed', async () => {
      ...
      await expect(service.upload(mockFile)).rejects.toThrow('対応していないファイル形式です')
    })
  ...
  describe('getPublicUrl', () => {
    ...
    it('should return public URL', () => {
      const mockUrl =
        'https://test.supabase.co/storage/v1/object/public/test-bucket/uploads/test.jpg'
      mockSupabaseClient.storage.getPublicUrl.mockReturnValueOnce({
