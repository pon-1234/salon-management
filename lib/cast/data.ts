...
export const castMembers: Cast[] = [
  {
    ...
    publicProfile: {
      ...
      shopMessage:
        'とっても人懐っこく、とっても明るいキレ可愛いセラピストさん。穏やかな表情と優しそうな雰囲気ながら、プレイに入ると小悪魔系に責め立ててくれる、天性の素質を兼ね備えた女性です。',
      customerMessage:
        '初めまして♡ みるくと申します✨✨ 名前の通り愛をたくさんお届けできたらなぁと思ってます♪',
    },
  },
  {
    id: '2',
...
export const generateCastSchedule = (
  castId: string,
  startDate: Date,
  endDate: Date
): CastSchedule[] => {
