 ...
 * @related_to   StoreLayout: store-specific title template; RegisterForm: customer registration surface
 * @known_issues Verification step metadata is handled by its own route
 */
