...
import { Phone, MapPin, Calendar, CreditCard, Edit, MessageSquare, X, Check, AlertCircle } from 'lucide-react'
...
export function ReservationDialog({
  ...
  const getStatusColor = (status: string) => {
    switch (status) {
      ...
      case 'modifiable': return 'bg-orange-500'
      case 'tentative': return 'bg-blue-500'
      ...
      <DialogContent className="max-w-3xl max-h-[90vh] p-0 overflow-hidden flex flex-col">
        ...
        <div className="flex-1 overflow-y-auto">
          <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
              ...
              <TabsList className="grid w-full grid-cols-3">
                ...
                <TabsTrigger value="history" className="relative">
                  ...
                  {modificationAlerts.length > 0 && (
                    <Badge variant="destructive" className="ml-1 px-1.5 py-0 h-4 text-[10px]">
            ...
            <TabsContent value="overview" className="p-4 space-y-4">
              ...
              {/* キャスト情報 */}
              <div className="bg-white border rounded-lg p-4">
                <h3 className="font-medium mb-3">担当キャスト</h3>
                <div className="flex items-center gap-3">
            ...
            <TabsContent value="details" className="p-4 space-y-4">
              {/* 顧客情報 */}
              <div className="bg-white border rounded-lg p-4">
                <h3 className="font-medium mb-3">顧客情報</h3>
                <div className="space-y-2">
                  <div className="flex items-center gap-2">
                    <Badge variant="outline" className="text-xs">
                      通常顧客
                  ...
                  <div className="text-sm space-y-1">
                    <p><span className="text-gray-600">利用回数:</span> 3回目</p>
                    <p><span className="text-gray-600">前回利用:</span> 2023/12/25</p>
                  </div>
                </div>
              </div>
              ...
              {/* 予約詳細 */}
              <div className="bg-white border rounded-lg p-4">
                <h3 className="font-medium mb-3">予約詳細</h3>
              ...
              {/* お客様からの連絡事項 */}
              <div className="bg-white border rounded-lg p-4">
                <h3 className="font-medium mb-3">お客様からの連絡事項</h3>
                <div className="space-y-2 text-sm">
                  <p><span className="text-gray-600">連絡希望時間:</span> 指定なし</p>
                  <p><span className="text-gray-600">ご要望:</span> 電話はタイミング的に出れない場合（出れなかった場合は折り返します）</p>
                  <p><span className="text-gray-600">連絡手段:</span> 電話 / メール / LINE</p>
                  <p><span className="text-gray-600">アレルギー・注意事項:</span> 特になし</p>
                </div>
              </div>

              {/* 店舗メモ */}
              <div className="bg-white border rounded-lg p-4">
                <h3 className="font-medium mb-3">店舗メモ</h3>
                <textarea 
              ...
              {/* 料金詳細 */}
              <div className="bg-white border rounded-lg p-4">
                <h3 className="font-medium mb-3">料金詳細</h3>
                <div className="space-y-2 text-sm">
              ...
              {/* 支払い・確認状況 */}
              <div className="bg-white border rounded-lg p-4">
                <h3 className="font-medium mb-3">状況</h3>
                <div className="space-y-3">
                  <div className="flex items-center justify-between">
                    <span className="text-sm text-gray-600">支払い</span>
                    <div className="flex items-center gap-2">
                      <Badge variant="outline" className="text-xs">現金</Badge>
                      <Badge variant="secondary" className="text-xs bg-yellow-100 text-yellow-700">未払い</Badge>
                    </div>
                  </div>
                  <div className="flex items-center justify-between">
                    <span className="text-sm text-gray-600">キャスト確認</span>
                    <Badge variant="secondary" className="text-xs bg-green-100 text-green-700">確認済み</Badge>
                  </div>
                  <div className="flex items-center justify-between">
                ...
                <div className="bg-orange-50 border border-orange-200 rounded-lg p-4">
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-xs text-orange-600 mt-1">30分間オーダーの修正が可能です</p>
        ...
        {isEditMode && (
          <div className="border-t p-4 bg-gray-50">
            <p className="text-xs text-gray-600 mb-2">ステータスを変更:</p>
